...
function Step1({ handleSelection }) {
	return (
		<div className='page'>
			...
			<div className='choices'>
				<Choice choiceText='Hidden' imgContent='img-hidden' value='1' onChange={handleSelection} />
				<Choice choiceText='U:Move' imgContent='img-umove' value='2' onChange={handleSelection} />
			</div>
		</div>
	);
}
